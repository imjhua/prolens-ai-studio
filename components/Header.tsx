        ...
        <div>
          ...
          <div className="mt-2 text-xs text-slate-500 text-left">
            ...
            <ul className="mt-1 list-disc list-inside space-y-0.5">
              <li><b>컷(Cut)</b>: 카메라가 멈추지 않고 한 번에 촬영하는 연속된 영상의 단위입니다. 영상의 한 장면을 구성합니다.</li>
              <li><b>씬(Scene)</b>: 동일한 시간, 장소, 상황에서 촬영된 여러 컷이 모여 하나의 이야기를 이루는 더 큰 단위입니다.</li>
              <li><b>소스 이미지</b>: 컷과 씬을 구체적으로 설계할 때 필요한 배경, 인물, 사물 등 다양한 요소 이미지를 의미합니다.</li>
            </ul>
          </div>
        </div>
