        ...
        <div>
          ...
          <div className="mt-2 text-xs text-slate-500 text-left">
            ...
            <ul className="mt-1 list-disc list-inside space-y-0.5">
              ...
              <li><b>소스 이미지</b>: 컷과 씬, 스토리보드를 구체적으로 설계할 때 필요한 배경, 인물, 사물 등 다양한 요소 이미지</li>
              <li><b>스토리보드(Storyboard)</b>: 컷 이미지를 순서대로 배열한 영상 설계도로 연출 의도, 카메라 움직임, 대사, 효과 등을 시각적으로 표현</li>
              <li><b>4컷 콘티(4-panel storyboard)</b>: 4개의 컷으로 구성한 간단한 콘티</li>
            </ul>
          </div>
        </div>
